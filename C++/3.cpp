...
const char* fragmentShaderSource = R"(
    ...
    out vec4 FragColor;
    void main(){
        FragColor = vec4(0.9, 0.7, 0.4, 1.0);
    }
)";
...
int main() {
    ...
    SDL_Window* window = SDL_CreateWindow("OpenGL + SDL2", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN);
    if (!window) {
